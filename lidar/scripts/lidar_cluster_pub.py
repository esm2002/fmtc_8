    ...
    def lidar_CB(self,msg):
        ...
        filtered_angles_short, filtered_nums_short, filtered_angles_mid, filtered_nums_mid, \
            filtered_angles_far, filtered_nums_far \
                = self.separate_points_by_angle(qualities, nums, angles, min_qualities=40, min_angle=0,max_angle=180,threshold_short=self.threshold_short, threshold_mid=self.threshold_mid,threshold_max=self.threshold_far)    
